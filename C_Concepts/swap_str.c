...
void swap_with_strlib(char* str1, char* str2){
    ...
    printf("In function swap_with_strlib, before swap, now str1 %s, str2 %s\n", str1, str2);
    printf("%d %d \n", len1, len2);
    ...
    str1[len2] = '\0';
    printf("In function swap_with_strlib, now str1 %s, str2 %s\n", str1, str2);
    free(tmp);
}
...
int main() { 
    ...
    swap_with_double_ptr(&p_str1, &p_str2); 
    printf("[ANS]: After swap_with_double_ptr(&p_str1, &p_str2) str1 is %s, str2 is %s\n", str1, str2);

    // swap_with_double_ptr(&str1, &str2); 
    // printf("[ANS]: After swap_with_double_ptr(&str1, &str2) str1 is %s, str2 is %s\n", str1, str2);
